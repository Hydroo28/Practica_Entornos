...
1. Clonar el repositorio desde GitHub:
   ```bash
   git clone https://github.com/Hydroo28/Practica_Entornos
   ```
...
4. Tambien se puede descargar en un zip el codigo desde la pagina: https://github.com/Hydroo28/Practica_Entornos
...
- Correo: `afercor2806@g.educaand.es`  
- Teléfono: `600 03 26 17`
...
---
Copyright (c) [2025] [AlejandroFddzz]
